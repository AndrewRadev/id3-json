...
- Linux: [binary](https://github.com/AndrewRadev/id3-json/releases/download/v0.3.0/id3-json-x86_64-unknown-linux-gnu.tar.xz)
- Windows: [binary](https://github.com/AndrewRadev/id3-json/releases/download/v0.3.0/id3-json-x86_64-pc-windows-msvc.zip)
- Mac (x86): [binary](https://github.com/AndrewRadev/id3-json/releases/download/v0.3.0/id3-json-x86_64-apple-darwin.tar.xz)
- Mac (ARM): [binary](https://github.com/AndrewRadev/id3-json/releases/download/v0.3.0/id3-json-aarch64-apple-darwin.tar.xz)
